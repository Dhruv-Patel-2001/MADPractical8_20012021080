package com.example.mad_practica8_20012021080
...
class MainActivity : AppCompatActivity(), Animation.AnimationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        alarmimagesAnimation = android.view.animation.AnimationUtils.loadAnimation(this, R.anim.alarm_animation)
        alarmimagesAnimation.setAnimationListener(this)

        heartAnimation = android.view.animation.AnimationUtils.loadAnimation(this, R.anim.heart_animation)
        alarmimagesAnimation.setAnimationListener(this)
    }
